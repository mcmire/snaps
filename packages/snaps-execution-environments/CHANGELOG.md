...
- Add script to spin up local instance of the Iframe Execution Environment ([#1502](https://github.com/mcmire/snaps/pull/1502))
...
- Remove `child-workspace-package-names-as-json` script in favour of `yarn workspaces filter` command ([#1491](https://github.com/mcmire/snaps/pull/1491))
- Bump @metamask/providers from 10.2.1 to 11.0.0 ([#1446](https://github.com/mcmire/snaps/pull/1446))
- Bump LavaMoat ([#1479](https://github.com/mcmire/snaps/pull/1479))
...
- Add SVG validation ([#1401](https://github.com/mcmire/snaps/pull/1401))
...
- Add LavaMoat policy generation and update Buffer global in inline-source-map ([#1369](https://github.com/mcmire/snaps/pull/1369))
...
- Only run Webpack before tests ([#1108](https://github.com/mcmire/snaps/pull/1108))
...
[0.10.5]: https://github.com/mcmire/snaps/compare/v0.10.4...v0.10.5
[0.10.4]: https://github.com/mcmire/snaps/compare/v0.10.3...v0.10.4
...
[0.10.0]: https://github.com/mcmire/snaps/releases/tag/v0.10.0
