...
- Disallow deriving Ethereum keys ([#1217](https://github.com/mcmire/snaps/pull/1217))
...
- add snapId to select logs ([#1333](https://github.com/mcmire/snaps/pull/1333))
...
- Bump @metamask/base-controller from 1.1.2 to 2.0.0 ([#1210](https://github.com/mcmire/snaps/pull/1210))
...
- Require `location` for `SnapController.updateSnap` ([#1124](https://github.com/mcmire/snaps/pull/1124))
...
- Fix CI after broken PR merge ([#1027](https://github.com/mcmire/snaps/pull/1027))
- Remove locally defined ActionHandler type in favor of imported type ([#1025](https://github.com/mcmire/snaps/pull/1025))
...
- Bump @metamask/browser-passworder from 3.0.0 to 4.0.2 ([#996](https://github.com/mcmire/snaps/pull/996))
- Simplify controller tests ([#983](https://github.com/mcmire/snaps/pull/983))
...
- Stop prefixing private functions and properties with `_` ([#930](https://github.com/mcmire/snaps/pull/930))
...
[0.9.0]: https://github.com/mcmire/snaps/compare/v0.8.1...v0.9.0
[0.8.1]: https://github.com/mcmire/snaps/compare/v0.8.0...v0.8.1
...
[0.2.0]: https://github.com/mcmire/snaps/compare/v0.1.2...v0.2.0
[0.1.2]: https://github.com/mcmire/snaps/compare/v0.1.1...v0.1.2
[0.1.1]: https://github.com/mcmire/snaps/compare/v0.1.0...v0.1.1
[0.1.0]: https://github.com/mcmire/snaps/compare/v0.0.9...v0.1.0
[0.0.9]: https://github.com/mcmire/snaps/compare/v0.0.7...v0.0.9
[0.0.7]: https://github.com/mcmire/snaps/compare/v0.0.6...v0.0.7
